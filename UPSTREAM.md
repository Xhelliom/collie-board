...
| `bridge/index.ts` | construct the board, copilot and adapters; six `engine.onUpdate` hooks; the `NotifyLog` and its coordinator hook — brick 18 in the ledger |
