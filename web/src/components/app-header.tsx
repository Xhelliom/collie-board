...
export function AppHeader({
  ...
  return (
    <header className="sticky top-0 z-20 flex items-center gap-2 border-b border-border/60 bg-chrome pl-4 pr-2 py-2 [padding-top:calc(env(safe-area-inset-top)_+_0.5rem)]">
      {override ?? (
        <>
